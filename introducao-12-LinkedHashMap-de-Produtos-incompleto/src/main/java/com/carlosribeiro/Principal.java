            ...
            switch (opcao) {
                ...
                case 5 -> {    // Ordenar por nome
                    ...
                    if (mapDeProdutos.isEmpty())
                        ...
                        // sort retorna void
                        ArrayList<Produto> produtos = new ArrayList<>(mapDeProdutos.values());
                        // produtos.sort(new ComparatorDeProdutosPorNome());
                ...
                case 6 -> {    // Ordenar por nome na ordem inversa
                    ...
                    if (mapDeProdutos.isEmpty())
                        ...
                        ArrayList<Produto> produtos = new ArrayList<>(mapDeProdutos.values());
                        produtos.sort(new ComparatorDeProdutosPorNome().reversed());
                        for (Produto produto : produtos) {
                            System.out.println("Número = " + produto.getNumero() +
                                    "   Nome = " + produto.getNome() +
                                    "   Lance mínimo = " + produto.getLanceMinimoMasc());
